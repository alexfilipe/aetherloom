...
- An opaque-relocation ambiguity has its own waiting decision and non-approvable hold for the exact tracked path. Its hold evidence lists the missing location and exact subtree-exclusion roots/reasons without inventing descendants. The preview says **Needs review** / **Paused for safety**, never shows the held record under **Move to trash**, and exposes no generic approval for it. A separately proven independent operation schedule can run without changing that preview or giving the held record execution authority.
