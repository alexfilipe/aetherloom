...
- Date: 2026-08-12
- PR/layer and exact relevant SHA(s): evaluation-loop documentation in PR [#20](https://github.com/alexfilipe/aetherloom/pull/20) on branch `claude/orchestration-framework-review-07538f`. Base at definition time: `main` at `1f1b9e1202252f8c7b9c367b5c69e5aa383c0fcf`, validated at head `84bd82a64220ca4b7466cefc4f798120cad9008c` by macOS CI [run 31583666633](https://github.com/alexfilipe/aetherloom/actions/runs/31583666633). Current base after integrating the merged PR #19: `main` at `c435d1c77a8052ebd0b1641a15bdb96e8eb4c492`, integrated by merge commit `d6ec44d1231cf28ef7aac74f6dc193193737e09f` and revalidated at that exact head by macOS CI [run 31583992360](https://github.com/alexfilipe/aetherloom/actions/runs/31583992360). The base change invalidated the first run as exact-head evidence; only the second run is authoritative. The commit carrying this correction requires one further exact-head run before the entry is canonical.
