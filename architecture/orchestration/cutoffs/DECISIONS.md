...
The policy governing these decisions is in [`README.md`](README.md) and the entry format is in [`TEMPLATE.md`](TEMPLATE.md), both beside this file. Entries recorded before 2026-08-12 cite this log at its former path, `architecture/cutoff-decisions.md`; those citations are left as written rather than rewritten, per the append-only rule.
