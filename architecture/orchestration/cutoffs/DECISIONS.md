...
- Residual risk/severity: Medium until exact-head macOS CI validates the combined branch. The duplicate `CUT-009` labels were a documentation ambiguity only, since titles and SHAs disambiguated them; they have since been renumbered.
